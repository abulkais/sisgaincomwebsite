...
<!-- Google tag (gtag.js) -->
<script  src="https://www.googletagmanager.com/gtag/js?id=G-QQD49NDHW8"></script>
<script>
...
<body>
    ...
    <div id="headerscroll" class="row container headerscroll1 headerScinline">
        ...
        <div id="topbarid" class="row  container-fluid navbar-fixed-top topinline oveflow-x:hidden;">
            <div id="topbar2 background1" class="col-sm-12  hidden-xs hidden-md hidden-sm topbar2inline">
                <div class="top-bar" itemscope itemtype="https://schema.org/Person">
                    <ul class="list-inline">
                        ...
                        <div class='sprite flag2'>
                            <img class="sprite sprite-Flag2" src="image/flag2.png" alt="flag">
                    ...
                    <div class="collapse navbar-collapse js-navbar-collapse" id="telemedicine-new">
                        <ul class="nav navbar-nav navbarinline" id="navActive" data-top="0" data-scroll="800" itemscope itemtype="https://www.schema.org/SiteNavigationElement" role="navigation">
                            <li class="dropdown mega-dropdown">
                                <!--<li class="dos.bis" itemprop="name"><a class="nav-link" href=" https://sisgain.com" itemprop="url">HOME</a></li>-->
                            ...
                            <li class="dropdown mega-dropdown" itemprop="name">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" itemprop="url">HIRE<span class="caret"></span></a>
                                <ul class="dropdown-menu mega-dropdown-menu menu-border">
                                    <li id="service5" class="col-sm-3">
                                        <ul itemscope itemtype="https://www.schema.org/SiteNavigationElement" role="navigation">
                                            <li class="dropdown-header box-size color-red"><img src="image/hire-mob.png" alt="check box">&nbsp;&nbsp;HIRE MOBILE APP DEVELOPERS</li>
                                            <br>

                                            <li class="crm-box" itemprop="name">
                                                <a href="https://sisgain.com/hire-android-developer" itemprop="url"><img src="image/red-check.png" alt="check Box">&nbsp;&nbsp;Hire Android Developer</a>
                                            </li>
                                            <li class="crm-box" itemprop="name">
                                                <a href="https://sisgain.com/hire-iphone-developer" itemprop="url"><img src="image/red-check.png" alt="check Box">&nbsp;&nbsp;Hire iPhone Developer</a>
                                            </li>
                                            <li class="crm-box" itemprop="name">
                                                <a href="https://sisgain.com/hire-ipad-developer" itemprop="url"><img src="image/red-check.png" alt="check Box">&nbsp;&nbsp;Hire iPad Developer</a>
                                            </li>
                                            <li class="crm-box" itemprop="name">
                                                <a href="https://sisgain.com/hire-ios-developer" itemprop="url"><img src="image/red-check.png" alt="check Box">&nbsp;&nbsp;Hire iOS Developer</a>
                                            </li>

                                            <li class="crm-box" itemprop="name">
                                                <a href="https://sisgain.com/hire-apple-watch-developer" itemprop="url"><img src="image/red-check.png" alt="check Box">&nbsp;&nbsp;Hire Apple Watch Developer</a>
                                            </li>
                                            <li class="crm-box" itemprop="name">
                                                <a href="https://sisgain.com/hire-ionic-developer" itemprop="url"><img src="image/red-check.png" alt="check Box">&nbsp;&nbsp;Hire Ionic Developer</a>
                                            </li>
                                            <li class="crm-box" itemprop="name">
                                                <a href="https://sisgain.com/hire-hybrid-app-developer" itemprop="url"><img src="image/red-check.png" alt="check Box">&nbsp;&nbsp;Hire Hybrid App Developer</a>
                                            </li>
                                            <li class="crm-box" itemprop="name">
                                                <a href="https://sisgain.com/hire-windows-app-developer" itemprop="url"><img src="image/red-check.png" alt="check Box">&nbsp;&nbsp;Hire Windows App Developer</a>
                                            </li>
                                            <li class="crm-box" itemprop="name">
                                                <a href="https://sisgain.com/hire-ui-ux-developer" itemprop="url"><img src="image/red-check.png" alt="check Box">&nbsp;&nbsp;Hire UI/UX Developer</a>
                                            </li>
                                            <li class="crm-box" itemprop="name">
                                                <a href="https://sisgain.com/hire-kubernetes-developer" itemprop="url"><img src="image/red-check.png" alt="check Box">&nbsp;&nbsp;Hire Kubernetes Developer</a>
                                            </li>

                                        </ul>
                                    </li>
                                    <li id="service6" class="col-sm-3">

                                        <ul itemscope itemtype="https://www.schema.org/SiteNavigationElement" role="navigation">
                                            <li class="dropdown-header  box-size color-yellow "><img src="image/hire-web.png" alt="check Box">&nbsp;&nbsp;HIRE WEB DEVELOPERS</li>
                                            <br>
                                            <li class="crm-box" itemprop="name">
                                                <a href="https://sisgain.com/hire-node-js-developer" itemprop="url"><img src="image/yellow-check.png" alt="check Box">&nbsp;&nbsp;Hire Node JS Developer</a>
                                            </li>
                                            <li class="crm-box" itemprop="name">
                                                <a href="https://sisgain.com/hire-offshore-developer" itemprop="url"><img src="image/yellow-check.png" alt="check Box">&nbsp;&nbsp;Hire Offshore Developer</a>
                                            </li>
                                            <li class="crm-box" itemprop="name">
                                                <a href="https://sisgain.com/hire-php-developer" itemprop="url"><img src="image/yellow-check.png" alt="check Box">&nbsp;&nbsp;Hire PHP Developer</a>
                                            </li>
                                            <li class="crm-box" itemprop="name">
                                                <a href="https://sisgain.com/hire-asp-net-developer" itemprop="url"><img src="image/yellow-check.png" alt="check Box">&nbsp;&nbsp;Hire ASP .NET Developer</a>
                                            </li>
                                            <li class="crm-box" itemprop="name">
                                                <a href="https://sisgain.com/hire-angular-js-developer" itemprop="url"><img src="image/yellow-check.png" alt="check Box">&nbsp;&nbsp;Hire Angular JS Developer</a>
                                            </li>
                                            <li class="crm-box" itemprop="name">
                                                <a href="https://sisgain.com/hire-laravel-developer" itemprop="url"><img src="image/yellow-check.png" alt="check Box">&nbsp;&nbsp;Hire Laravel Developer</a>
                                            </li>
                                            <li class="crm-box" itemprop="name">
                                                <a href="https://sisgain.com/hire-wordpress-developer" itemprop="url"><img src="image/yellow-check.png" alt="check Box">&nbsp;&nbsp;Hire WordPress Developer</a>
                                            </li>
                                            <li class="crm-box" itemprop="name">
                                                <a href="https://sisgain.com/hire-magento-developer" itemprop="url"><img src="image/yellow-check.png" alt="check Box">&nbsp;&nbsp;Hire Magento Developer</a>
                                            </li>
                                            <li class="crm-box" itemprop="name">
                                                <a href="https://sisgain.com/hire-codeigniter-developer" itemprop="url"><img src="image/yellow-check.png" alt="check Box">&nbsp;&nbsp;Hire Codeigniter Developer</a>
                                            </li>
                                            <li class="crm-box" itemprop="name">
                                                <a href="https://sisgain.com/hire-html-css-developer" itemprop="url"><img src="image/yellow-check.png" alt="check Box">&nbsp;&nbsp;Hire HTML5, CSS Developer</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li id="service7" class="col-sm-6" align="center">
                                        <ul>
                                            <li class="dropdown-header achive-head4 box-size">Client Engagement Model</li>
                                            <br>
                                            <li><img src="image/hire-ban.png" class="myimg" alt="Client Engagement Model"></li>
                                        </ul>
                            ...
                            <li class="dos.bis" itemprop="name"><a href="https://sisgain.com/contact" itemprop="url">CONTACT US</a></li>
