                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="contact__sec">
                                <form action="mail" method="post" onsubmit="return form_validate();" data-aos="fade-up" data-aos-duration="1500">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                ...
                                                <p class="btn bg_default_blue formbuttonshow w-100" style="display: none;  cursor: not-allowed! important; opacity:0.5;  background-color: #4A25AA; border-radius:10px; font-size: medium; text-align:center;"> Please wait</p>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12">
