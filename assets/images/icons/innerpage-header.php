...
<!--<link href="https://fonts.googleapis.com/css?family=Raleway,Regular&display=swap" rel="stylesheet">

    <link type="text/plain" rel="author" href="https://www.gerbers.ch/humans.txt" />-->


<!-- Global site tag (gtag.js) - Google Ads: 400851659 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-400851659"></script>
<script>
    ...
    gtag('config', 'AW-400851659');
</script>
<script>
    window.addEventListener('load', function() {
        jQuery('[href*="tel:"]').click(function() {
            gtag('event', 'conversion', {
                'send_to': 'AW-400851659/dLgQCOiz5aQCEMuFkr8B'
            });
        })
    })
</script>

<meta name="google" content="readthispage">
...
<script type="text/javascript">
    ...
    })(window, document, "clarity", "script", "7zw1jtdg8a");
</script>

<!-- Event snippet for Submit lead form- Telemedicine conversion page
...
<script>
    function gtag_report_conversion(url) {
        ...
        gtag('event', 'conversion', {
            'send_to': 'AW-400851659/6IGMCJiV_oQCEMuFkr8B',
...
<script>
    function gtag_report_conversion(url) {
        ...
        gtag('event', 'conversion', {
            'send_to': 'AW-400851659/hd7CCInrgIUCEMuFkr8B',
            'event_callback': callback
        });
        return false;
    }
...
<!-- Event snippet for Submit lead form- Remote Patient Monitoring conversion page
In your html page, add the snippet and call gtag_report_conversion when someone clicks on the chosen link or button. -->
<script>
    function gtag_report_conversion(url) {
        var callback = function() {
        ...
        gtag('event', 'conversion', {
            'send_to': 'AW-400851659/gDVACLiLioUCEMuFkr8B',
            'event_callback': callback
        });
        return false;
    }
...
<!-- Event snippet for Submit lead form- Pharmacy Management conversion page
In your html page, add the snippet and call gtag_report_conversion when someone clicks on the chosen link or button. -->
<script>
    function gtag_report_conversion(url) {
        var callback = function() {
        ...
        gtag('event', 'conversion', {
            'send_to': 'AW-400851659/hH6vCKKXjYUCEMuFkr8B',
            'event_callback': callback
        });
        return false;
    }
...
<!-- Event snippet for Submit lead form- HL7 conversion page
In your html page, add the snippet and call gtag_report_conversion when someone clicks on the chosen link or button. -->
<script>
    function gtag_report_conversion(url) {
        var callback = function() {
        ...
        gtag('event', 'conversion', {
            'send_to': 'AW-400851659/NyIcCN7fjoUCEMuFkr8B',
            'event_callback': callback
        });
        return false;
    }
...
<!-- Event snippet for Submit lead form- Telehealth conversion page
In your html page, add the snippet and call gtag_report_conversion when someone clicks on the chosen link or button. -->
<script>
    function gtag_report_conversion(url) {
        var callback = function() {
        ...
        gtag('event', 'conversion', {
            'send_to': 'AW-400851659/U8n6CNbOkogCEMuFkr8B',
            'event_callback': callback
        });
        return false;
    }
...
<script type="application/ld+json">
    {
        ...
        "potentialAction": {
            "@type": "SearchAction",
            "target": "https://sisgain.com/?s={search_term}",
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-104689915-1"></script>
<script>
    window.dataLayer = window.dataLayer || [];
    ...
    gtag('config', 'UA-104689915-1');
</script>

<script>
    /*  Start of Async Drift Code */ ! function() {
        var t;
                ...
                <div class="top-bar" itemscope itemtype="https://schema.org/Person">
                    <ul class="list-inline">
                        ...
                        <div class='sprite flag2'>
                            ...
                            <a href="tel:+971.50.6271276" itemprop="name">
                                <span class="topBarFont" itemprop="telephone" style="color:#000;">+971.50.6271276</span>
                            </a>
                        </div>
                        <!-- <div class='sprite flag2'>
                            <img class="sprite sprite-Flag2" src="image/canada.webp" alt="flag">
                            <a href="tel:+1.647.336.0444" itemprop="name">
                                <span class="topBarFont" itemprop="telephone" style="color:#000;">+1.647.336.0444</span>
                            </a>
                        </div> -->
