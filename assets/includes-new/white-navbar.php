...
<nav class="navbar">
    <a href="https://sisgain.com/" class="logo">
        <img class="logo-white" loading="lazy" src="https://sisgain.com/assets/images/white-logo.webp" alt="Sisgain Logo">
        <img class="logo-color" loading="lazy" src="https://sisgain.com/assets/images/logo.webp" alt="Sisgain Logo">
    </a>
    <ul class="nav-links">
            ...
            <div class="mm-grid">
                ...
                <div class="mm-col">
                    ...
                    <div class="mm-section">
                        ...
                        <a href="http://sisgain.com/cloud-managed-services" class="mm-svc-link">Cloud Managed Services</a>
        ...
        <div class="ind-body">
            ...
            <div class="ind-section">
                ...
                <div class="ind-grid">
                    ...
                    <a href="https://sisgain.com/fitness-club-management" class="ind-link">
                        <div class="ind-dot"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
                                <path d="M18 20V10" />
                                <path d="M12 20V4" />
                                <path d="M6 20v-6" />
                            </svg></div>
                        <span class="ind-lname">Fitness</span>
                    </a>
    ...
    <div class="mob-inner">
        ...
        <div class="mob-acc"><button class="mob-trigger" onclick="toggleAcc(this)">Infrastructure &amp; Cloud <svg class="arr" width="14" height="14" viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="mob-body">
                ...
                <a href="http://sisgain.com/cloud-managed-services" class="mob-svc">Cloud Managed Services</a>
...
<script>
    ...
    function toggleAcc(t) {
        ...
        const allBodies = document.querySelectorAll('.mob-body');
        const allTriggers = document.querySelectorAll('.mob-trigger');

        // close all
        allBodies.forEach(x => x.classList.remove('open'));
        allTriggers.forEach(x => x.classList.remove('open'));
